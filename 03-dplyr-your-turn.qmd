...
1.  Use the `sanitation_national_2020_od` data and the function `filter()` to identify the number of countries with 0% for the indicator "no sanitation facilities" in 2020.
